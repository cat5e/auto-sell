...
public class JanelaEditarIntervencao extends javax.swing.JInternalFrame {
    ...
    private void popularDados() {
        textFieldDataIntervencao.setText(getDateFormated(intervencao.getData()));
        ...
        try {
            ...
            if (intervencao == null) {
                intervencao = new Intervencao(
                        parseLocalDate(textFieldDataIntervencao.getText()),
                        veiculo,
    ...
    private boolean isDadosValidos() {
        ...
        return isDateCorrect(this, textFieldDataIntervencao);
    }
